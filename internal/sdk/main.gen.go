...
// Defines values for OAuthApplicationCollectionSysType.
const (
	OAuthApplicationCollectionSysTypeArray OAuthApplicationCollectionSysType = "Array"
)

// Valid indicates whether the value is a known member of the OAuthApplicationCollectionSysType enum.
func (e OAuthApplicationCollectionSysType) Valid() bool {
	switch e {
	case OAuthApplicationCollectionSysTypeArray:
		return true
	default:
		return false
	}
...
// Defines values for OAuthApplicationScope.
const (
	ContentManagementManage OAuthApplicationScope = "content_management_manage"
	ContentManagementRead   OAuthApplicationScope = "content_management_read"
)

// Valid indicates whether the value is a known member of the OAuthApplicationScope enum.
func (e OAuthApplicationScope) Valid() bool {
	switch e {
	case ContentManagementManage:
		return true
	case ContentManagementRead:
		return true
	default:
		return false
	}
...
type OAuthApplication struct {
	// ClientId Public identifier of the OAuth application
	ClientId string `json:"clientId"`

	// ClientSecret Client secret. Only returned in the response to the create endpoint
	// and cannot be retrieved later — store it immediately.
	ClientSecret *string `json:"clientSecret,omitempty"`

	// Confidential Whether the client is confidential (server-side, can keep the
	// `clientSecret`) or public (e.g. SPA/mobile/CLI).
	Confidential bool `json:"confidential"`

	// Description Description of the OAuth application
	Description string `json:"description"`

	// Name Human-readable name of the OAuth application
	Name string `json:"name"`

	// RedirectUri Redirect URI used in the OAuth authorization code flow
	RedirectUri string `json:"redirectUri"`

	// Scopes Scopes granted to access tokens issued for this application
	Scopes []OAuthApplicationScope          `json:"scopes"`
	Sys    SystemPropertiesOAuthApplication `json:"sys"`
}

// OAuthApplicationCollection defines model for OAuthApplicationCollection.
type OAuthApplicationCollection struct {
	Items *[]OAuthApplication `json:"items,omitempty"`
	Limit *int                `json:"limit,omitempty"`
	Skip  *int                `json:"skip,omitempty"`
	Sys   *struct {
		Type *OAuthApplicationCollectionSysType `json:"type,omitempty"`
	} `json:"sys,omitempty"`
	Total *int `json:"total,omitempty"`
}

// OAuthApplicationCollectionSysType defines model for OAuthApplicationCollection.Sys.Type.
type OAuthApplicationCollectionSysType string

// OAuthApplicationDraft defines model for OAuthApplicationDraft.
type OAuthApplicationDraft struct {
	// Confidential Whether the client is confidential (server-side, can keep the
	// `clientSecret`) or public (e.g. SPA/mobile/CLI).
	Confidential bool `json:"confidential"`
...
// OAuthApplicationScope OAuth scope granted to access tokens issued for this application.
//   - `content_management_manage` — full Content Management API access.
//   - `content_management_read` — read-only Content Management API access.
type OAuthApplicationScope string
...
// SystemPropertiesOAuthApplication defines model for SystemPropertiesOAuthApplication.
type SystemPropertiesOAuthApplication struct {
	CreatedAt *time.Time `json:"createdAt,omitempty"`
